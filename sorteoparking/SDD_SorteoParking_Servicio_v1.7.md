...
## Versión 1.7 — Migración a notificaciones por correo electrónico
...
|Stack|Python · FastAPI · SQLite · DeepSeek Flash|
...
|OTP|Consejeros presentes o en Zoom|Consejeros remotos por correo electrónico|
...
|CONSEJERO|5 miembros del Consejo (dinámicos)|Recibir OTP por correo · Confirmar OTP · Observar ejecución · Descargar acta|
|RESIDENTE|Participante del sorteo|Vista pública de resultados sin login · Verificar seed|
|SISTEMA|SorteoParking Cloud|Aislar datos por tenant · Ejecutar algoritmo · Enviar OTP por correo · Notificar resultados · Generar actas · Log encadenado|
...
|OTP Engine|Python · SHA-256|Generación · Entrega por correo · Validación · Expiración|
|Notificaciones|Email SMTP|Resultados del sorteo a participantes|
...
class Tenant(Base):
    ...
    # Eliminado en v1.7 - ya no se usa WhatsApp
...
|POST|`/sorteos/iniciar`|Crea sorteo + consejeros + envía OTPs por correo electrónico|201 Sorteo · 409 en curso|
...
|POST|`/sorteos/{id}/notificar`|Envía resultados por correo electrónico a participantes|200 ResumenEnvio · 500|
...
## 6\. Protocolo de notificación por correo electrónico

### 6.1 Diferencia respecto a v1.4.3

En v1.4.3 los OTPs se confirmaban con consejeros presentes o en Zoom. En v1.7 los consejeros pueden estar en cualquier lugar — reciben su OTP por correo electrónico y confirman desde cualquier dispositivo accediendo a la URL del panel OTP.

### 6.2 Flujo del protocolo

1. TENANT\_ADMIN inicia el sorteo e ingresa el correo electrónico de los 5 consejeros.
2. El sistema genera 5 OTPs únicos (SHA-256) con expiración de 30 minutos.
3. Cada consejero recibe por correo: su OTP, el nombre del conjunto y un enlace directo al panel de confirmación.
4. El consejero abre el enlace desde su dispositivo e ingresa su OTP.
...
|---|---|---|
| Longitud | 6 dígitos | UX óptima para correo electrónico |
...
|Administración del conjunto|Confirmar correos de los 5 consejeros garantes|
...
### Mes 2 — OTP remoto y notificaciones por correo electrónico

|ID|Tarea|Spec ref.|
|-|-|-|
|T-201|Integración servicio SMTP para envío de OTPs por correo|§6.2|
...
|T-204|Notificaciones de resultados por correo electrónico a participantes|§5.3|
|T-205|Vista pública residente: resultados y seed sin login|§5.4|
|T-206|Servicio de correo electrónico como canal único de notificación|§3.2|
...
|CA-03|OTP llega por correo electrónico en menos de 2 minutos|CONSEJERO|⏳|
...
|CA-10|Acta NO incluye correos electrónicos de participantes|Ley 1581|⏳|
...
| email | "correo@ejemplo.com" | `[TEXTO]` |
...
- Números de teléfono de participantes
...
| CA-T110-03 | El acta NO incluye correos electrónicos de participantes | ⏳ |
...
|1.7|Mayo 2026|Migración a notificaciones por correo electrónico — eliminación de WhatsApp como canal de OTP y notificaciones · §6 reescrito como protocolo de notificación por correo · eliminado componente Canal OTP §3.2 · T-201/T-204/T-206 actualizados a email · CA-03/CA-10 actualizados · whatsapp_admin eliminado §4.1|Michael López|
